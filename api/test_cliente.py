...
def test_obtener_pasajeros(request, api_url, token_cliente, record_property):
    ...
    record_property("status_code", response.status_code)  # Guardar el status code en las propiedades de la prueba para su uso en los hooks.
